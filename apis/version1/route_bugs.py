...
Aca se crean las rutas para los bugs
Si se hace una peticion http a la ruta:
    -/bugs/create-dish se puede crear un plato
    -/bugs/get/{id} se recibe el plato con ese id
    -/bugs/get/all se reciben todos los platos
"""
